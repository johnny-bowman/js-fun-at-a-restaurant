...
let vegetables = ['broocoli', 'carrot', 'green beans', 'brussel sprouts', 'potato']
...
// different fruits.
let fruits = ['banana', 'orange', 'apple', 'jack fruit', 'watermelon', 'rasberry', 'blueberry']
...
groceryStore = {name: 'King Soopers', isOpen: true }
